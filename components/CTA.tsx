  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="relative isolate overflow-hidden bg-custom-pink px-6 pt-16 shadow-2xl rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <svg
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 className="text-3xl font-bold tracking-tight text-custom-dark sm:text-4xl">
              Ready to dive in?
              <br />
              Start using Ciro today.
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-700">
              Join thousands of users who are transforming their productivity. It's free to get started.
            </p>
          ...
          <div className="relative mt-16 h-80 lg:mt-8">
            <img
              ...
              src="https://picsum.photos/1140/640"
              alt="App screenshot"
              width="1824"
              height="1080"
            />
